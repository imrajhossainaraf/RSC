  ...
  return (
    <div className={styles.authContainer}>
      <div className={styles.authCard}>
        ...
        <button onClick={() => signIn('google', { callbackUrl })} className={styles.socialBtn}>
        ...
        <button onClick={() => signIn('github', { callbackUrl })} className={styles.socialBtn}>
        ...
        <div className={styles.linkText}>
          Don&apos;t have an account? <Link href={registerHref}>Register here</Link>
        </div>
      </div>
    </div>
  );
